...
#[inline(always)]
pub fn transform_mat3<'a, 'b, T: Num>(out: &'a mut [T; 3], a: &'b [T; 3], m: [T; 9]) -> &'a mut [T; 3] {
...
#[inline(always)]
pub fn transform_mat4<'a, 'b, T: Num>(out: &'a mut [T; 3], a: &'b [T; 3], m: [T; 16]) -> &'a mut [T; 3] {
...
#[inline(always)]
pub fn transform_mat4_rotation<'a, 'b, T: Num>(out: &'a mut [T; 3], a: &'b [T; 3], m: [T; 16]) -> &'a mut [T; 3] {
...
#[inline(always)]
pub fn transform_projection<'a, 'b, T: Num>(out: &'a mut [T; 3], a: &'b [T; 3], m: [T; 16]) -> &'a mut [T; 3] {
...
#[inline(always)]
pub fn transform_projection_no_position<'a, 'b, T: Num>(out: &'a mut [T; 3], a: &'b [T; 3], m: [T; 16]) -> &'a mut [T; 3] {
    let mut d = a[0] * m[3] + a[1] * m[7] + a[2] * m[11] + m[15];
    d = if d != T::zero() {T::one() / d} else {d};
...
#[inline(always)]
pub fn transform_quat<'a, 'b, T: Num>(out: &'a mut [T; 3], a: &'b [T; 3], q: [T; 4]) -> &'a mut [T; 3] {
...
#[inline(always)]
pub fn position_mat32<'a, 'b, T: Num>(out: &'a mut [T; 3], m: [T; 6]) -> &'a mut [T; 3] {
    out[0] = m[4];
    out[1] = m[5];
    out
}
...
#[inline(always)]
pub fn position_mat4<'a, 'b, T: Num>(out: &'a mut [T; 3], m: [T; 16]) -> &'a mut [T; 3] {
    out[0] = m[12];
    out[1] = m[13];
    out[2] = m[14];
    out
...
#[inline(always)]
pub fn scale_mat2<'a, 'b, T: Num>(out: &'a mut [T; 3], m: [T; 4]) -> &'a mut [T; 3] {
...
#[inline(always)]
pub fn scale_mat32<'a, 'b, T: Num>(out: &'a mut [T; 3], m: [T; 6]) -> &'a mut [T; 3] {
    out[0] = length_values(m[0], m[2], T::zero());
    out[1] = length_values(m[1], m[3], T::zero());
    out[2] = T::one();
    out
...
#[inline(always)]
pub fn scale_mat3<'a, 'b, T: Num>(out: &'a mut [T; 3], m: [T; 9]) -> &'a mut [T; 3] {
...
#[inline(always)]
pub fn scale_mat4<'a, 'b, T: Num>(out: &'a mut [T; 3], m: [T; 16]) -> &'a mut [T; 3] {
